...
namespace WolfCurses.Window.Form
{
        ...
        where TData : WindowData, new()
    {
        ...
        ///         <see cref="OnTick" />, paced by an <see cref="IntervalTimer" /> and stored in a field that this
        ///         method hands straight back. A form whose text is genuinely cheap, or which only changes when
        ///         something else changed it, can compose here and loses nothing.
        ///     </para>
        ///     <para>
        ///         The other half of that pattern is <see cref="RestartOnActivate" />: a form stops being ticked while
        ///         a modal window sits on top of it, but its clock does not stop measuring — so without registering
        ///         the timer, the form comes back owing every step that fell due and takes them all at once.
        ///     </para>
        /// </summary>
        /// <returns>
