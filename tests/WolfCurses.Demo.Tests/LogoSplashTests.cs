...
namespace WolfCurses.Demo.Tests
{
    ...
    ///     </para>
    ///     <para>
    ///         In the <see cref="DemoAppCollectionMembership">non-parallel collection</see> because it moves
    ...
    public class LogoSplashTests
    {
        ...
        /// <summary>Documentation anchor for the collection this class joins; see <see cref="Support.DemoAppCollection" />.</summary>
        private sealed class DemoAppCollectionMembership
        {
        }
    }
}
