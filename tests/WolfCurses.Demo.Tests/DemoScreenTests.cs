...
namespace WolfCurses.Demo.Tests
{
    ...
    /// </summary>
    [Collection("DemoApp")]
    public class DemoScreenTests
    {
        [Fact]
        public void ItOpensOnTheAsciiWordmark()
        {
            using var app = new DrivenDemoApp();
        ...
        public void EnterDismissesTheSplashAndRevealsTheMenu()
        {
            ...
            Assert.Contains("Demo Console Application", app.Screen, StringComparison.Ordinal);
        ...
        public void EscapeBacksOutOfADemoToTheMenu()
        {
            ...
            app.ChooseMenuItem((int) DemoCommandsEnum.PrideFlags);
            var demo = app.Screen;
        ...
        public void TheProgressAndGraphDemoAnimatesOffTheTick()
        {
            ...
            app.ChooseMenuItem((int) DemoCommandsEnum.ProgressAndGraphs);
        ...
        public void AnImageDemoDrawsSomethingRatherThanTheErrorCheckerboard()
        {
            ...
            app.ChooseMenuItem((int) DemoCommandsEnum.Slideshow);
            app.Tick(3);
        ...
        public void TheImageErrorDemoShowsWhyEachLoadFailed()
        {
            ...
            app.ChooseMenuItem((int) DemoCommandsEnum.ImageErrorDemo);
            app.Tick(2);
