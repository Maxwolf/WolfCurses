...
namespace SimulationUnit.Window.Form
{
    using System;
    ...
    {
        /// <summary>Initializes a new instance of the <see cref="T:SimulationUnit.Window.Form.ParentWindowAttribute" /> class.</summary>
