...
using WolfCurses.Demo.CustomInput;
using WolfCurses.Demo.Screens;
using WolfCurses.Graphics;
using WolfCurses.Demo.Prompt;
using WolfCurses.Demo.Question;
using WolfCurses.Window;

namespace WolfCurses.Demo
{
    /// <summary>
    ///     Demo window implementation that is attached to wolf curses list of active windows during runtime.
    /// </summary>
    public sealed class DemoWindow : Window<DemoCommandsEnum, DemoWindowInfo>
    {
        /// <summary>
        ...
        public DemoWindow(SimulationApp simUnit) : base(simUnit)
        {
        }
        ...
        public override void OnWindowPostCreate()
        {
            ...
            AddCommand(TextPrompt, DemoCommandsEnum.TextPrompt);
            AddCommand(YesNoPrompt, DemoCommandsEnum.YesNoPrompt);
            AddCommand(CustomPrompt, DemoCommandsEnum.CustomPrompt);
            AddCommand(ShowSlideshow, DemoCommandsEnum.Slideshow);
            AddCommand(ShowCompositeSlideshow, DemoCommandsEnum.CompositeSlideshow);
            AddCommand(OpenImageFile, DemoCommandsEnum.OpenImageFile);
            AddCommand(SelectFolder, DemoCommandsEnum.SelectFolder);
            AddCommand(ShowProgressAndGraphs, DemoCommandsEnum.ProgressAndGraphs);
            AddCommand(SelectFromList, DemoCommandsEnum.SelectFromList);
            AddCommand(MultiSelectList, DemoCommandsEnum.MultiSelectList);
            AddCommand(ShowMessageBox, DemoCommandsEnum.MessageBoxDemo);
            AddCommand(TextInput, DemoCommandsEnum.TextInputDemo);
            AddCommand(PasswordInput, DemoCommandsEnum.PasswordDemo);
            AddCommand(ForceRenderType, DemoCommandsEnum.ForceRenderType);
            AddCommand(ShowAnimatedGif, DemoCommandsEnum.ShowAnimatedGif);
            AddCommand(ShowSpriteTest, DemoCommandsEnum.SpriteTestBasic);
            AddCommand(ShowAdvancedSpriteTest, DemoCommandsEnum.SpriteTestAdvanced);
            AddCommand(ShowCollisionSpriteTest, DemoCommandsEnum.SpriteTestCollision);
            AddCommand(ShowImageErrors, DemoCommandsEnum.ImageErrorDemo);
            AddCommand(ShowPrideFlags, DemoCommandsEnum.PrideFlags);
            AddCommand(CloseSimulation, DemoCommandsEnum.CloseSimulation);
        ...
        /// <summary>
        ///     ESC backs out of whichever demo is showing and returns to the main menu. Every demo in this app is a
        ...
        private void RefreshMenuHeader()
        {
            ...
            headerText.Append(
                $"{Environment.NewLine}Demo Console Application{Environment.NewLine}{Environment.NewLine}");
            headerText.AppendLine("Render type: " + DescribeCurrentRenderType());
            headerText.AppendLine("Demo UserData: " + UserData.DemoUserData);
