...
namespace WolfCurses.Demo.Screens
{
    ...
    ///         lays its stripes out in order and the picture falls out of the widget the demo app already had. That
    ...
    public sealed class PrideFlagDialog : Form<DemoWindowInfo>
    {
