...
namespace WolfCurses.Demo.Screens
{
    ...
    ///     <see cref="DemoWindowInfo.LastResult" /> and switch to this form; pressing ENTER returns to the menu.
    /// </summary>
    [ParentWindow(typeof (DemoWindow))]
    public sealed class ControlResultDialog : InputForm<DemoWindowInfo>
    {
