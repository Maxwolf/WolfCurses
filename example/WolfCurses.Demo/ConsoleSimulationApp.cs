...
namespace WolfCurses.Demo
{
    ...
    public sealed class ConsoleSimulationApp : SimulationApp
    {
        ...
        /// </summary>
        public DemoModule ModuleDemo { get; private set; }
        ...
        // AllowedWindows is deliberately NOT overridden: the base class discovers DemoWindow from this assembly
        ...
        {
            // Demo module that ticks all the time with us unlike a form that only ticks when active.
            ModuleDemo = new DemoModule();
        }
        ...
        public override string OnPreRender()
        {
            ...
            tui.AppendLine($"Demo Module: {ModuleDemo.DemoModuleData}");
            return tui.ToString();
        }
        ...
        public override void OnTick(bool systemTick, bool skipDay = false)
        {
            ...
            // Tick the module.
            ModuleDemo?.OnTick(systemTick, skipDay);
        }
        ...
        public override void Restart()
        {
            ...
            // Attach demo window after the first tick.
            WindowManager.Add(typeof (DemoWindow));
        }
    }
}