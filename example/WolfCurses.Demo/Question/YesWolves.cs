...
namespace WolfCurses.Demo.Question
{
    [ParentWindow(typeof (DemoWindow))]
    public sealed class YesWolves : InputForm<DemoWindowInfo>
    {
        /// <summary>
        ...
        protected override string OnDialogPrompt()
        {
            ...
            return $"{Environment.NewLine}You like wolves! Yayyy!{Environment.NewLine}";
        }
